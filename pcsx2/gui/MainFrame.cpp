...
void MainEmuFrame::ConnectMenus()
{
    ...
    Bind(wxEVT_MENU, &MainEmuFrame::Menu_EnableLua_Click, this, MenuId_EnableLua);
...

{
	...
	wxString wintitle;
    wintitle.Printf( L"PCSX2-EX v3.00.0 [Base 1.6.0]" );
    ...
    m_menuSys.Append(MenuId_EnableLua, _("Enable LuaEngine"),
                     wxEmptyString, wxITEM_CHECK);
...
void MainEmuFrame::ApplyConfigToGui(AppConfig& configToApply, int flags)
{
	...
	{//these should not be affected by presets
        ...
        menubar.Check( MenuId_EnableLua, configToApply.EmuOptions.EnableLua );
